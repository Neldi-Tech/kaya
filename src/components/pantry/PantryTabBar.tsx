...
const TABS = [
  ...
  { path: '/pantry/utility',     icon: '⚡', label: 'Utility',  match: 'prefix' as const, parentOnly: false },
  { path: '/pantry/payroll',     icon: '🤝', label: 'Payroll',  match: 'prefix' as const, parentOnly: false },
