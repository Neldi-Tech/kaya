...
export const GAME_WORLDS: WorldDef[] = [
  { id: 'quick',     label: 'Quick Plays', emoji: '⚡', blurb: 'Fast solo games',  countLabel: '9 games · solo' },
...
export const GAMES: GameDef[] = [
  ...
  { id: 'memory-match',  name: 'Memory Match',     world: 'quick', icon: '🧠', tone: 'coral',  minAge: 4, minutes: 3,  points: 15, device: 'both', players: '1–4', built: true, note: 'solo, same device or 2 phones' },
  ...
  { id: 'sliding-puzzle', name: 'Sliding Puzzle',  world: 'quick', icon: '🧩', tone: 'pink',   minAge: 5, minutes: 5,  points: 20, device: 'both', players: '1–4', built: true },
  ...
  { id: 'tycoon',         name: 'Kaya Tycoon',     world: 'family', icon: '🏙️', tone: 'gold',   minAge: 6, minutes: 30, points: 0,  device: 'both',  players: '2–6', built: true, note: 'Own phones · one device · or big-screen · just for fun' },
