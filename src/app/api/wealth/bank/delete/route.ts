// POST /api/wealth/bank/delete — remove a bank account after a fresh 2FA
// step-up. Body: { code, acctId }.

import { NextRequest, NextResponse } from 'next/server';
import { verifyBearer } from '@/lib/wealthVaultServer';
import { deleteBankAccount } from '@/lib/bankVaultServer';
...
export async function POST(req: NextRequest) {
  ...
  try {
    return NextResponse.json(await deleteBankAccount(who.uid, b.acctId, b.code));
  } catch {
