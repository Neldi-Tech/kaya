  ...
  return (
    <div className="bg-hive-paper border-2 border-hive-honey/50 rounded-hive-lg p-4">
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 rounded-[12px] bg-hive-honey-soft text-hive-honey-dk flex items-center justify-center text-xl shrink-0">🚀</div>
        <div className="flex-1 min-w-0">
          <p className="font-nunito font-extrabold text-[13px]">Launch request</p>
