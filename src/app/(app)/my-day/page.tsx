...
import { setMeetingSubmission, type MeetingSubmission } from '@/lib/meetingSubmissions';
...
// ── Sunday-Meeting v2 (b2) · Pre-meeting prep card ─────────────────
...
function MeetingPrepCard({
  ...
  // We surface the card when:
  //   • there's no schedule set yet (so families who haven't configured
  //     can still pre-fill), OR
  //   • the schedule is within the next 7 days (i.e. always — the
  //     "3 days before" window in the proposal is configurable, default
  //     is "any time before").
  // Hiding the card requires an explicit "filled and dismissed" flag,
