    ...
    <div className="min-h-screen bg-[#FFFBF5] pb-20">
      <div className="mx-auto max-w-md sm:max-w-2xl">
        ...
        >
          ...
          <div className="font-display text-[19px] font-extrabold mt-0.5">✨ Wish Shelf</div>
        ...
        <div className="px-4 mt-3">
          ...
          {wishes?.map((w) => (
            <div key={w.id} className="rounded-[14px] border border-[#ECE4D3] bg-white p-3 mb-2">
          ...
          <div className="rounded-[14px] border border-[#BFE3D8] bg-[#F1FAF7] p-3 mt-1">
            <input
              value={text}
